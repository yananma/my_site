...
class Banner(models.Model):
    text_info1 = models.CharField('信息10000', max_length=50, default='')
    text_info2 = models.CharField('信息2', max_length=50, default='')
    text_info3 = models.CharField('信息3', max_length=50, default='')
    cover = models.ImageField('轮播图', upload_to='static/assets/images/banner')
    link_url = models.URLField('图片链接')
...
class Course(models.Model):
    ...
    cover = models.ImageField('课程封面', upload_to='static/assets/images/courses')
    ...
    # 星级
    star = models.CharField('星级', max_length=50)
    # 价格
...
class Blog(models.Model):
    ...
    cover = models.ImageField('博客封面', upload_to='static/assets/images/blog', default=None)
